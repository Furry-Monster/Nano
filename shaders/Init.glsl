...
layout(std430, binding = 0) buffer FWorkArgs0 { uint mData[]; }
WorkArgs0;
layout(std430, binding = 1) buffer FWorkArgs1 { uint mData[]; }
WorkArgs1;
layout(std430, binding = 2) buffer FMainAndPostNodeAndClusterBatches { uint mData[]; }
MainAndPostNodeAndClusterBatches;
layout(std430, binding = 3) buffer FVisBuffer64 { uint64_t mData[]; }
VisBuffer64;
void main()
{
