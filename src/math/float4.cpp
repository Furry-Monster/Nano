...
float4 Min(const float4& a, const float4& b) {
    return float4(MinValue(a.x, b.x), MinValue(a.y, b.y),
                  MinValue(a.z, b.z), MinValue(a.w, b.w));
}

float4 Max(const float4& a, const float4& b) {
    return float4(MaxValue(a.x, b.x), MaxValue(a.y, b.y),
                  MaxValue(a.z, b.z), MaxValue(a.w, b.w));
}
