...
void matrix4::Perspective(float fovDegrees, float aspect, float nearPlane, float farPlane) {
    std::memset(v, 0, sizeof(v));
...
void matrix4::LookAt(const float4& eye, const float4& target, const float4& up) {
    float4 z = eye - target;
    z.Normalize();
    float4 x = cross(up, z);
    x.Normalize();
...
matrix4 matrix4::Invert() const {
    ...
    ret._11 =  GetMIJ(1, 1).Determinant(); ret._12 = -GetMIJ(1, 2).Determinant();
    ret._13 =  GetMIJ(1, 3).Determinant(); ret._14 = -GetMIJ(1, 4).Determinant();
    ret._21 = -GetMIJ(2, 1).Determinant(); ret._22 =  GetMIJ(2, 2).Determinant();
    ret._23 = -GetMIJ(2, 3).Determinant(); ret._24 =  GetMIJ(2, 4).Determinant();
    ret._31 =  GetMIJ(3, 1).Determinant(); ret._32 = -GetMIJ(3, 2).Determinant();
    ret._33 =  GetMIJ(3, 3).Determinant(); ret._34 = -GetMIJ(3, 4).Determinant();
    ret._41 = -GetMIJ(4, 1).Determinant(); ret._42 =  GetMIJ(4, 2).Determinant();
    ret._43 = -GetMIJ(4, 3).Determinant(); ret._44 =  GetMIJ(4, 4).Determinant();
...
matrix4 matrix4::operator*(const matrix4& m) const {
    matrix4 ret;
    ret._11 = dot4(float4(_11, _12, _13, _14), float4(m._11, m._21, m._31, m._41));
    ret._12 = dot4(float4(_11, _12, _13, _14), float4(m._12, m._22, m._32, m._42));
    ret._13 = dot4(float4(_11, _12, _13, _14), float4(m._13, m._23, m._33, m._43));
    ret._14 = dot4(float4(_11, _12, _13, _14), float4(m._14, m._24, m._34, m._44));

    ret._21 = dot4(float4(_21, _22, _23, _24), float4(m._11, m._21, m._31, m._41));
    ret._22 = dot4(float4(_21, _22, _23, _24), float4(m._12, m._22, m._32, m._42));
    ret._23 = dot4(float4(_21, _22, _23, _24), float4(m._13, m._23, m._33, m._43));
    ret._24 = dot4(float4(_21, _22, _23, _24), float4(m._14, m._24, m._34, m._44));

    ret._31 = dot4(float4(_31, _32, _33, _34), float4(m._11, m._21, m._31, m._41));
    ret._32 = dot4(float4(_31, _32, _33, _34), float4(m._12, m._22, m._32, m._42));
    ret._33 = dot4(float4(_31, _32, _33, _34), float4(m._13, m._23, m._33, m._43));
    ret._34 = dot4(float4(_31, _32, _33, _34), float4(m._14, m._24, m._34, m._44));

    ret._41 = dot4(float4(_41, _42, _43, _44), float4(m._11, m._21, m._31, m._41));
    ret._42 = dot4(float4(_41, _42, _43, _44), float4(m._12, m._22, m._32, m._42));
    ret._43 = dot4(float4(_41, _42, _43, _44), float4(m._13, m._23, m._33, m._43));
    ret._44 = dot4(float4(_41, _42, _43, _44), float4(m._14, m._24, m._34, m._44));
    return ret;
}
