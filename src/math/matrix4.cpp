...
void    matrix3::operator=(const matrix3& inRightValue) { memcpy(v, inRightValue.v, sizeof(v)); }
...
void matrix4::LookAt(const float4& inCameraPosition, const float4& inTargetPosition, const float4& inHelpVector)
{
...
void   matrix4::operator=(const matrix4& inM) { memcpy(v, inM.v, sizeof(v)); }
